...
h = 0.05 
t = v = 0 # t= 시간 v= 각속도
x = 30*np.pi/180 #진자의 회전 각도
pen_fm = 0.01 # 마찰계수
pen_m = 0.1
pen_l = 100*0.01 #줄의 길이
pen_J = 0.02
pen_g = 9.8
gndCenterX = 500
gndConterY = 40
...
aurthorSrf = font.render('', True, (50, 50, 50))
...
while loopFlag:
    ...
    pygame.draw.line(srf, (100, 100, 100), (gndCenterX,
                                            gndConterY), (updatedX, updatedY), 2)
    pygame.draw.circle(srf, (100, 100, 100),
                       (int(updatedX), int(updatedY)), 10, 0)
